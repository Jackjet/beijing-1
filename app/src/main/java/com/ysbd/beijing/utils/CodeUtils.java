...
public class CodeUtils {
    ...
    private static final int RANGE_PADDING_LEFT = 55;//左边距范围值
    private static final int BASE_PADDING_TOP = 62;//上边距
    private static final int RANGE_PADDING_TOP = 35;//上边距范围值
    private static final int DEFAULT_WIDTH = 350;//默认宽度.图片的总宽
    private static final int DEFAULT_HEIGHT = 100;//默认高度.图片的总高
    private static final int DEFAULT_COLOR = 0xDF;//默认背景颜色值0xDF
