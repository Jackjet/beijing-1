...
public class JieyuzijinList extends BaseListFragment {
    ...
    public static JieyuzijinList getInstance(String type, String actor) {
        JieyuzijinList fragment = new JieyuzijinList();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        inflate.findViewById(R.id.yibanfawen_bar).setVisibility(View.VISIBLE);
        unbinder = ButterKnife.bind(this, inflate);
        initToDo1();
        initView();
        inflate.findViewById(R.id.dangqianbanli).setVisibility(View.GONE);
        return inflate;
    }
