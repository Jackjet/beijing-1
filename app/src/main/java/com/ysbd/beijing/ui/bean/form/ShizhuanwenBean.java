...
public class ShizhuanwenBean extends BaseFormBean{
     ...
     * nian : 2018
     * qitarenyijian :
     * recievedate : 2018-07-25 00:00:00.0
     * riseword :
     * shangjiducha :
     * shifoufawen :
     * subwokflow_fawen :
     ...
     * subworkflow_zhibiao :
     * wenjianmingcheng : 二姨
     * workflowinstance_guid : {0A2FF324-FFFF-FFFF-CF4D-4C6000000008}
     * workflow_main :
     * workflow_sub :
     * xianbandate :
     * xianbanriqi :
    ...
    private String shizhengfubianhao;
    ...
    public void setShilingdaopishi(String shilingdaopishi) {
        this.shilingdaopishi = shilingdaopishi;
    }
    ...
    public String getShizhengfubianhao() {
        return shizhengfubianhao;
    }

    public void setShizhengfubianhao(String shizhengfubianhao) {
        this.shizhengfubianhao = shizhengfubianhao;
    }
